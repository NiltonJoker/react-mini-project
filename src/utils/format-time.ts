 ...
 * output: Apr 2022
 */
export function fRelative(date: DatePickerFormat, format?: string) {
  ...
  return isValid ? dayjs(date).format(format ?? formatStr.relative) : 'Invalid time value';
}